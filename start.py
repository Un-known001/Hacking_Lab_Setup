...
def banner():
    print(f'''
                    ...
                    {white}      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@                         
                    {white}    @@@@@@@   @@@@@@@@@@@@@@@@@@@@@@@                       
                       @@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@@& {cyan}| Telegram :: @Sastahack7{white}           
                       @@@@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@ {green}| Github :: @Un-known001{white}   
                      .@@@@@@@@@@@@@*  &@@@@@@@@@@@@@@@@@@ {red}| Youtube :: @KkidBby{white}     
...
def update():
    ...
    git_ver = str(
        requests.get(
            "https://github.com/Un-known001/Hacking-lab-setup-.git/main/.version"
        ).text
    ).split()
    if version == git_ver[0]:
        ...
        changelog = requests.get(
            "https://github.com/Un-known001/Hacking-lab-setup-.git/main/.changelog.log"
        ).text
        update_commands = requests.get(
            "https://github.com/Un-known001/Hacking-lab-setup-.git/main/.update"
        ).text
        system("clear")
        banner()
        print(
